...
export const scrapers: ScraperConfig[] = [
  createFotocasaConfig(['https://www.fotocasa.es/es/alquiler/viviendas/torrejon-de-ardoz/todas-las-zonas/l']),
  createPisosConfig(['https://www.pisos.com/alquiler/pisos-torrejon_de_ardoz/']),
]
